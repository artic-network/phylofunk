...
public class TreeFunk extends Funk {
     ...
     * @param isVerbose
     */
    TreeFunk(String metadataFileName, String taxaFileName, String indexColumn, int indexHeader, String headerDelimiter, boolean isVerbose) {
        super(isVerbose);
